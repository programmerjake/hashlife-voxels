...
#ifndef GRAPHICS_DRIVERS_OPENGL_1_DRIVER_H_
#define GRAPHICS_DRIVERS_OPENGL_1_DRIVER_H_
...
namespace drivers
{
class OpenGL1Driver final : public SDL2Driver
{
private:
...
public:
    ...
    explicit OpenGL1Driver(std::string title)
...
#endif /* GRAPHICS_DRIVERS_OPENGL_1_DRIVER_H_ */
